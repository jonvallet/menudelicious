INSERT INTO restaurant (id, name, description, address1, address2, town, county, postcode, category_id, phone, photo_url)
  VALUES (2, 'The Library', 'Calm spot in former library with original woodwork, doing steaks and burgers from a wood-fired oven.', '4A Guildhall Hill', '', 'Norwich', 'Norfolk', 'NR2 1JH', 1, '01603 616606', 'Library.JPG');


INSERT INTO restaurant (id, name, description, address1, address2, town, county, postcode, category_id, phone, photo_url)
  VALUES (3, '', '', '4A Guildhall Hill', '', 'Norwich', 'Norfolk', 'NR2 1JH', 1, '01603 616606', 'Library.JPG');


INSERT INTO restaurant (id, name, description, address1, address2, town, county, postcode, category_id, phone, photo_url)
  VALUES (4, 'The Library', '', '4A Guildhall Hill', '', 'Norwich', 'Norfolk', 'NR2 1JH', 1, '01603 616606', 'Library.JPG');


INSERT INTO restaurant (id, name, description, address1, address2, town, county, postcode, category_id, phone, photo_url)
  VALUES (5, 'The Library', '', '4A Guildhall Hill', '', 'Norwich', 'Norfolk', 'NR2 1JH', 1, '01603 616606', 'Library.JPG');
